            ...
            <div className="main">
                <div className="section-heading" id="about">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" viewBox="0 0 482.9 482.9" style={{ enableBackground: 'new 0 0 482.9 482.9' }}
                        xmlSpace="preserve" height="100%" strokeWidth="16">
                        <g>
                    ...
                    <p className="profile_blurb">Fully committed to the philosophy of life-long learning, I’m a full stack developer
                        with a deep passion for JavaScript, React and all things web development. The unique combination of
                        creativity, logic, technology and never running out of new things to discover, drives my excitement and
                        passion for web development. When I’m not at my computer I like to spend my time reading, keeping fit
                        and playing Cricket.</p>
                </div>
